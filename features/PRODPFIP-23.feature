Feature: PRODPFIP-23 Possibility to see the profile page of the service
  ...
  Scenario Outline: Profile page of the service is displayed after clicking on the search result
    ...
    And I add service with "<title>", "<category>", "<user_name>", "<email>", "<phone>", "<user_info>", "<basic_info>", "<basic_price>", "<extended_info>", "<extended_price>", "<extra_info>", "<extra_price>"
    ...
    Examples:
      ...
      | test             | test  | inne     | test      | test@domain.com | 888555222 | test      | test       | 10          | test          | 20             | test       | 30          |
