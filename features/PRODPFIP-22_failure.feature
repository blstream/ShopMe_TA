Feature PRODPFIP-22 failure error message
  ...
  Scenario: Display error message ofter enter non existing address url
    When I go to ShopMe main page
  ...
  Scenario: Hyperlink in offer description
    Given I go to ShopMe main page
    ...
    And I fill in basicDescription with hyperlink "https://www.google.com/"
  ...
  Scenario: Existing email
    ...
    When I change email adress with john.doe@gmail.com
    And I fill in password with "Password1"
